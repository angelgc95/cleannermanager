...
SELECT legacy_users.user_id, 'cleaner'
FROM (
  VALUES
    ('4ea0a0ac-fffa-4a40-a25b-1a1cfb30e330'::uuid),
    ('1d6d7acc-6caf-4902-b4aa-7f72bcd79ad6'::uuid),
    ('8f7d32f9-b152-48f9-abb0-081ef3738eae'::uuid)
) AS legacy_users(user_id)
JOIN auth.users ON auth.users.id = legacy_users.user_id
